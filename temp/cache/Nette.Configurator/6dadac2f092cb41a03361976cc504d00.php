<?php
// source: E:\Box\Box Sync\Dokumenty\IT4\Nette\ctvrty\app/config/config.neon 
// source: E:\Box\Box Sync\Dokumenty\IT4\Nette\ctvrty\app/config/config.local.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			'nette\\object' => array(
				...
				'22_App_Model_Calendar',
				'23_App_Model_TasksModel',
			...
			'app\\model\\calendar' => array('22_App_Model_Calendar'),
			'app\\model\\tasksmodel' => array('23_App_Model_TasksModel'),
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'E:\\Box\\Box Sync\\Dokumenty\\IT4\\Nette\\ctvrty\\app',
			'wwwDir' => 'E:\\Box\\Box Sync\\Dokumenty\\IT4\\Nette\\ctvrty\\www',
			'debugMode' => TRUE,
			...
			'tempDir' => 'E:\\Box\\Box Sync\\Dokumenty\\IT4\\Nette\\ctvrty\\app/../temp',
			'database' => array(
				'driver' => 'mysql',
				'host' => '127.0.0.1',
				'username' => 'root',
	...
	/**
	 * @return App\Model\Calendar
	 */
	public function createService__22_App_Model_Calendar()
	{
		$service = new App\Model\Calendar($this->getService('nette.database.default.context'));
		return $service;
	}


	/**
	 * @return App\Model\TasksModel
	 */
	public function createService__23_App_Model_TasksModel()
	{
		$service = new App\Model\TasksModel($this->getService('nette.database.default.context'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('E:\\Box\\Box Sync\\Dokumenty\\IT4\\Nette\\ctvrty\\app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('E:\\Box\\Box Sync\\Dokumenty\\IT4\\Nette\\ctvrty\\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=mydb', 'root', NULL, NULL);
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('E:\\Box\\Box Sync\\Dokumenty\\IT4\\Nette\\ctvrty\\app/../temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('E:\\Box\\Box Sync\\Dokumenty\\IT4\\Nette\\ctvrty\\app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('E:\\Box\\Box Sync\\Dokumenty\\IT4\\Nette\\ctvrty\\app/../temp/cache', $this->getService('nette.cacheJournal'));
