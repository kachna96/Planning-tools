/**
 * Created by kachna96 on 10.1.2015.
 */
$(document).ready(function () {
    $("span.question").hover(function () {
        $(this).append('<div class="tooltip"><p class="red">Dovolená</p><p class="blue">Zadané úkoly</p></div>');
    }, function () {
        $("div.tooltip").remove();
    });
});
/*asdasdsasasdasda*/
$(function(){
    $("table.listOfTasks").stickyTableHeaders();
});
